...
#define LENGTH 100
	...
	char_T buf02[LENGTH];
	mxGetString(ssGetSFcnParam(S, 2), buf02, LENGTH);
	strScope->assign(buf02);

	char_T buf03[LENGTH];
	mxGetString(ssGetSFcnParam(S, 1), buf03, LENGTH);
...
static void mdlUpdate(SimStruct *S, int_T tid) {
	...
	//	cout << "sending message to Unity: " << __TIME__ << " " << strBML << endl;
